...
# ----------------------------------------
NUM_SAMPLES = 4  # Number of different hyper parameter setting
MAX_NUM_EPOCHS = 5  # Maximum number of epochs in training
N_EPOCHS_STOP = 1  # Number of consecuetive epochs with no improvement in validation data before terminating training
GRACE_PERIOD = 5  # Minimum number of epochs before termination is allowed
# ----------------------------------------

# Define final train parameters
# ----------------------------------------
MAX_NUM_EPOCHS_FINAL = 5
N_EPOCHS_STOP_FINAL = 1
